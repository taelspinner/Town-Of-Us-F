                ...
                for (var i = 0; i < __instance.AllPlayers.Count; i++)
                {
                    ...
                    if (!playerInfo.Disconnected && playerInfo.Tasks != null && playerInfo.Object &&
                        ...
                        !(
                            ...
                            playerInfo._object.Is(RoleEnum.Lawyer) || playerInfo._object.Is(RoleEnum.Mercenary) ||
                            ...
                            playerInfo._object.Is(RoleEnum.Vampire) || playerInfo._object.Is(RoleEnum.Scavenger) ||
                            playerInfo._object.Is(RoleEnum.Fanatic) || playerInfo._object.Is(RoleEnum.SoulCollector) ||
        ...
        private class Console_CanUse
        {
            private static bool Prefix(Console __instance, [HarmonyArgument(0)] NetworkedPlayerInfo playerInfo, ref float __result)
            {
                ...
                var flag = playerControl.Is(RoleEnum.Glitch)
                           ...
                           || playerControl.Is(RoleEnum.Fanatic)
